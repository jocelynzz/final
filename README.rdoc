...
* I refer to this website for the development of follow/unfollow relationships between users: https://www.railstutorial.org/book/following_users

* I use tinymce rails version to implement the rich-text editor: https://github.com/spohlenz/tinymce-rails

* I use Kaminari, recommendated by the professor, for paggination: https://github.com/amatsuda/kaminari
